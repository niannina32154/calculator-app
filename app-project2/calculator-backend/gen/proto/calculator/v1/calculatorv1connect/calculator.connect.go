...
import (
	v1 "calculatorbackend/gen/proto/calculator/v1"
...
type CalculatorServiceClient interface {
	Calculate(context.Context, *connect.Request[v1.CalculationRequest]) (*connect.Response[v1.CalculationResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CalculatorServiceClient {
	...
	calculatorServiceMethods := v1.File_proto_calculator_v1_calculator_proto.Services().ByName("CalculatorService").Methods()
	return &calculatorServiceClient{
		calculate: connect.NewClient[v1.CalculationRequest, v1.CalculationResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect.Client[v1.CalculationRequest, v1.CalculationResponse]
}

// Calculate calls calculator.v1.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect.Request[v1.CalculationRequest]) (*connect.Response[v1.CalculationResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect.Request[v1.CalculationRequest]) (*connect.Response[v1.CalculationResponse], error) {
